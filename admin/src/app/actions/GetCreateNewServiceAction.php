...
class GetCreateNewServiceAction extends AbstractAction
{
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        } elseif (!$this->authorizationService->isGranted($_SESSION['admin']['email'], AuthorizationService::CREATE_SERVICE, '')) {
